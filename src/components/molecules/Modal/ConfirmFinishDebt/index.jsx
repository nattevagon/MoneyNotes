import { BanknotesIcon, CheckBadgeIcon, CreditCardIcon, XMarkIcon } from "@heroicons/react/24/solid"
import { Link, useNavigate } from "react-router-dom"
import { getStorage, saveStorage } from "@/helper/localStorage";

const ConfirmFinishDebt = ({ onConfirm, onClose }) => {
  return (
    <dialog className="modal" open>
      <div className="modal-box">
        <h3 className="font-bold text-lg mb-4">Really want to finish this debt?</h3>
